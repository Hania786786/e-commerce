...
const ProductList = () => {
  ...
  // Handling Filters on category page
  ...
  useEffect(() => {
    ...
    dispatched(fetchProductsByFilterAsync({ filter, sort, pagination }));
    // dispatched(fetchAllProductsAsync());
  }, [dispatched, filter, sort, page]);
                                  ...
                                  <div className="mt-4 flex justify-between">
                                    <div>
                                      ...
                                      <p className="mt-1 text-sm text-gray-500">
                                        <StarIcon className="w-6 h-6 inline text-yellow-200"></StarIcon>
                                        <span className="align-bottom m-1">
                                          {product.rating}
                                        </span>
                                      </p>
                                    </div>
            ...
            >
              ...
              {Array.from({
                ...
                <div
                  ...
                  py-2 text-sm font-semibold  focus:z-20 focus-visible:outline 
