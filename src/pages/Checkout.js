  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-center  pt-10 text-5xl font-bold">Checkout</h2>
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-5 xl:gap-x-8">
          <div className="lg:col-span-3">
            <form className="bg-white px-5 mb-5 py-4 mt-12">
              <div className="space-y-12">
                <div className="border-b py-5 border-gray-900/10 pb-12">
          ...
          <div className="lg:col-span-2 mt-2">
            <div className="mx-auto mt-10 my-auto max-w-7xl px-0 sm:px-0 lg:px-0 bg-white">
              <h2 className="text-4xl text-center py-3">Cart</h2>
